...
export const constantRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'dhb', name: 'SupplyDhbOverview', component: () => import('@/views/supply-chain/dhb/DhbPage.vue'), meta: { title: '订货宝同步概览', requiresAuth: true, applicationCode: 'SUPPLY_CHAIN', pageKey: 'overview' } },
      { path: 'dhb/order-mirror', name: 'SupplyDhbOrderMirror', component: () => import('@/views/supply-chain/dhb/DhbPage.vue'), meta: { title: '订单镜像', requiresAuth: true, applicationCode: 'SUPPLY_CHAIN', pageKey: 'order-mirror' } },
      { path: 'dhb/sync-tasks', name: 'SupplyDhbSyncTasks', component: () => import('@/views/supply-chain/dhb/DhbPage.vue'), meta: { title: '同步任务', requiresAuth: true, applicationCode: 'SUPPLY_CHAIN', pageKey: 'sync-tasks' } },
      { path: 'dhb/sync-logs', name: 'SupplyDhbSyncLogs', component: () => import('@/views/supply-chain/dhb/DhbPage.vue'), meta: { title: '同步日志与死信', requiresAuth: true, applicationCode: 'SUPPLY_CHAIN', pageKey: 'sync-logs' } },
      { path: 'dhb/connections', name: 'SupplyDhbConnections', component: () => import('@/views/supply-chain/dhb/DhbPage.vue'), meta: { title: '连接配置', requiresAuth: true, applicationCode: 'SUPPLY_CHAIN', pageKey: 'connections' } },
      { path: 'dhb/field-mappings', name: 'SupplyDhbFieldMappings', component: () => import('@/views/supply-chain/dhb/DhbPage.vue'), meta: { title: '字段映射', requiresAuth: true, applicationCode: 'SUPPLY_CHAIN', pageKey: 'field-mappings' } },
      { path: 'dhb/data-quality', name: 'SupplyDhbDataQuality', component: () => import('@/views/supply-chain/dhb/DhbPage.vue'), meta: { title: '数据质量', requiresAuth: true, applicationCode: 'SUPPLY_CHAIN', pageKey: 'data-quality' } },
      { path: 'dhb/bi-prep', name: 'SupplyDhbBiPrep', component: () => import('@/views/supply-chain/dhb/DhbPage.vue'), meta: { title: 'BI数据准备', requiresAuth: true, applicationCode: 'SUPPLY_CHAIN', pageKey: 'bi-prep' } },
    ],
  },
]
