...
export const constantRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'order/settlement/collections', name: 'SupplyOrderSettlementCollections', component: () => import('@/views/supply-chain/order/IndexView.vue'), meta: { title: '回款状态', requiresAuth: true, applicationCode: 'SUPPLY_CHAIN', pageKey: 'settlement-collections' } },
      { path: 'order/settlement/reconciliation', name: 'SupplyOrderSettlementReconciliation', component: () => import('@/views/supply-chain/order/IndexView.vue'), meta: { title: '对账差异', requiresAuth: true, applicationCode: 'SUPPLY_CHAIN', pageKey: 'settlement-reconciliation' } },
