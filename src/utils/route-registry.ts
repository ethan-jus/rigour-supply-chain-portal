...
const ROUTES: Record<string, string | null> = {
  ...
  'supply.order.settlement.collections': null,
  'supply.order.settlement.receipts': '/supply-chain/order/settlement/receipts',
  'supply.order.settlement.payments': '/supply-chain/order/settlement/payments',
  'supply.order.settlement.reconciliation': '/supply-chain/order/settlement/reconciliation',
  'supply.order.settlement.differences': '/supply-chain/order/settlement/differences',
