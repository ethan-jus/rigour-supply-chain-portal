...
const ROUTES: Record<string, string | null> = {
  ...
  'supply.sales.menu': null, 'supply.sales.index': '/supply-chain/sales',
  ...
  'supply.dhb.overview': '/supply-chain/dhb',
  'supply.dhb.order-mirror': '/supply-chain/dhb/order-mirror',
  'supply.dhb.sync-tasks': '/supply-chain/dhb/sync-tasks',
  'supply.dhb.sync-logs': '/supply-chain/dhb/sync-logs',
  'supply.dhb.connections': '/supply-chain/dhb/connections',
  'supply.dhb.field-mappings': '/supply-chain/dhb/field-mappings',
  'supply.dhb.data-quality': '/supply-chain/dhb/data-quality',
  'supply.dhb.bi-prep': '/supply-chain/dhb/bi-prep',
}
